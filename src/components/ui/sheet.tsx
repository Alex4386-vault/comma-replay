  ...
  return (
    <SheetPrimitive.Portal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "fixed inset-y-0 z-50 flex h-full w-full max-w-sm flex-col bg-popover text-sm text-popover-foreground shadow-lg ring-1 ring-foreground/10 duration-200 outline-none data-open:animate-in data-closed:animate-out",
          side === "right" &&
